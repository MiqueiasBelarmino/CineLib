...
class FilmesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create filme" do
    assert_difference('Filme.count') do
      post filmes_url, params: { filme: { ano: @filme.ano, diretor: @filme.diretor, nome: @filme.nome, nota: @filme.nota, sinopse: @filme.sinopse } }
    end
  ...
  test "should update filme" do
    patch filme_url(@filme), params: { filme: { ano: @filme.ano, diretor: @filme.diretor, nome: @filme.nome, nota: @filme.nota, sinopse: @filme.sinopse } }
